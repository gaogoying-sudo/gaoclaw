...
echo ""
echo "  ${YELLOW}3. 安装可选依赖${NC}"
echo ""
echo "     # Graphify（代码图谱，推荐安装）"
echo "     pip3 install graphify"
echo "     # 或访问 https://github.com/safishamsi/graphify"
echo ""
echo "     # Obsidian（知识管理，桌面应用）"
echo "     # 访问 https://obsidian.md 下载安装"
echo ""
echo "  ${YELLOW}4. 开始使用${NC}"
echo "     admin chat "你好""
echo "     dev chat "继续开发""
echo "     architect chat "分析一下""
echo ""
echo "  ${YELLOW}5. 查看文档${NC}"
